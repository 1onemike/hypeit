...
<div class='col-sm-4 col-lg-4 col-md-4'>
             <div class='thumbnail'   >
               ...
               <div id="wrapper">
                ...
                <h4> <font color='black'> <span class='glyphicon glyphicon-bullhorn'></span> Number of Hypes:  <span id='<?php echo $recent  ?>'><?php echo $row['no_of_hypes']  ?> </span>  </font></h4>
        ...
        $sql_query = "SELECT hypes_hyped FROM users WHERE id = '$user_id'  ";
          ...
          if($exists == true ){
            ...
            ?>
                        ...
                        <a  class="btn btn-primary atopa" name="<?php echo $recent ?>" id='<?php echo $row['id'].'atopa' ?>' value="<?php echo $user_id ?>">
