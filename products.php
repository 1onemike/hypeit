  ...
  <script>(function(d, s, id) {
    ...
    <ul class="nav nav-pills  nav-justified  " style="background-color: #E6E6E6;">  
      <li  ><a href="all.php">ALL HYPES</a></li>  
        ...
        <li class="active"><a href="#"> <span class="glyphicon glyphicon-tags"></span> PRODUCTS</a></li>      
         <li ><a href="business.php"><span class="glyphicon glyphicon-usd"></span> BUSINESS /  <span class="glyphicon glyphicon-cargo"></span> SERVICES</a></li> 
         </div>  
...
<br><br>
   ...
   <div class="container">
      ...
      <div class="row">
                             ...
                             $sqltest = "SELECT * FROM valid_hypes  WHERE `category`='product' ORDER BY id DESC ";
